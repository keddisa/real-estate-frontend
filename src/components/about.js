                ...
                <div className="about-cards">
                    <div className="about-card">
                        ...
                        <div className="about-text">
                            <div className="about-text-title">We are here to bridge the gap</div>
                            <div className="about-text-main">Did you know that in the United States there are roughly five times as many vacant houses as there are homeless people?<br /><br />As a company specializing in really estate investments, we aspire to support our communities to minimize this gap.
                        </div>
                        </div>
                    </div>
                    <div className="about-card">
                        ...
                        <div className="about-text">
                            <div className="about-text-title">Want to make the most out of your home sale?</div>
                            <div className="about-text-main">We buy houses as-is and in the condition they are currently in.<br /><br />Regardless of mortgage or debt situation, our clients receive creative solutions to get the most out of their home equity with a smooth transition to their next home. Contact us for more details and consultation.
                    </div>
                        </div>
                    </div>
                    <div className="about-card">
                        ...
                        <div className="about-text">
                            <div className="about-text-title">Looking for your next home?</div>
                            <div className="about-text-main">No matter what your credit history looks like, whether you have the cash to buy a house or not, we are here to help you find you next home.<br /><br />Whatever your need, please get in touch for a free consultation.
                        </div>
                        </div>
                    </div>
                </div>
